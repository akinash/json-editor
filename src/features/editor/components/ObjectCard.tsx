                ...
                <Select
                  ...
                  onChange={(e) => {
                    onChange({
                      ...
                      data: {
                        ...entry.data,
                        options: applyRuleType(entry.data.options, e.target.value as DateRuleType),
                      },
                    });
                  }}
                >
            ...
            {ruleType === "range" ? (
              <>
                <Box sx={{ gridColumn: { xs: "1 / -1", md: "span 4" } }}>
                  <TextField
                    label="Дата начала"
                    value={uiDateFromJsonDate(entry.data.options.start)}
                    onChange={(e) =>
                      setOptions({ start: normalizeRangeDateForJson(e.target.value) }, "desktop")
                    }
                    fullWidth
                    placeholder="ДД.ММ"
                  />
                ...
                <Box sx={{ gridColumn: { xs: "1 / -1", md: "span 4" } }}>
                  <TextField
                    label="Дата конца"
                    value={uiDateFromJsonDate(entry.data.options.end)}
                    onChange={(e) =>
                      setOptions({ end: normalizeRangeDateForJson(e.target.value) }, "desktop")
                    }
                    fullWidth
                    placeholder="ДД.ММ"
                  />
